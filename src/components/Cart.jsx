...
const Cart = () => {
  ...
  return (
    <div className="bg-half-transperent w-full fixed nav-item top-0 right-0">
      <div className="float-right h-screen duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8">
          ...
          <div key = {index}>
            <div>
              <div className='flex items-center leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4'>
                <img className='rounded-lg h-80 w-24' scr={item.image} alt=""/>
                <div>
        ...
        <div className='mt-3 mb-3'>
          ...
          <div className='flex justify-between items-center mt-3'>
            <p className='text-gray-500 dark:text-gra-200'>Total</p>
            <p className='font-semibold'> $890</p>
          </div>
        </div>
        <div className='mt-5'>
          <Button color="white" bgColor={currentColor} text="Place Order"
